...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='CIFAR', help='folder | cifar10 | mnist ')
        ...
        self.parser.add_argument('--nz', type=int, default=500, help='size of the latent z vector')
        ...
        self.parser.add_argument('--lr', type=float, default=0.00010, help='initial learning rate for adam')
        self.parser.add_argument('--w_adv', type=float, default=1, help='Adversarial loss weight')
        self.parser.add_argument('--w_con', type=float, default=1, help='Contextual loss weight')
        self.parser.add_argument('--w_enc', type=float, default=1, help='Encoder loss weight')
        self.parser.add_argument('--w_rec', type=float, default=50, help='Reconstruction loss weight')
        
        # Train 커스텀
        self.parser.add_argument('--encoder_loss_ratio', type=float, default=0.5, help='Weight for encoder loss ratio between original latent and masked latent vectors')

        
        # 커스텀
        self.parser.add_argument('--context_mask_size', type=int, default=64, help='Size of the random mask for Contextual Prediction')
        self.parser.add_argument('--use_context_pred', action='store_true', help='Enable Contextual Prediction during training')
